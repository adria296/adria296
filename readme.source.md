<div style={{
  ...
  <style>
    {`
      @keyframes float-slow {
        ...
        50% { transform: translateX(350px); opacity: 1; }
      }
  ...
  <div style={{
    ...
    height: 96,
    borderRadius: 48,
    background: 'linear-gradient(135deg, #ff2222, #8b0000)',
    display: 'flex',
    alignItems: 'center',
    ...
    <img
      src={
        (github && github.user && github.user.avatarUrl) ||
  ...
  <div style={{
    ...
    <div style={{
      ...
      {(github && github.user && (github.user.name || github.user.login)) ||
        'GitHub Developer'}
    </div>
    ...
    <div style={{
      ...
      {(github && github.user && github.user.bio) ||
        ...
        return (
          <div
            ...
            style={{
              ...
              border: '1px solid rgba(240,70,70,0.32)',
